...
export default function Navbar() {
  ...
  const inActive= "py-2 m-1 px-3 font-medium text-gray-700 hover:text-gray-900 border-2 hover:border-primary shadow-sm rounded-lg cursor-pointer bg-slate-200/70";
  const active  = "py-2 m-1 px-3 font-medium text-gray-700 hover:text-gray-900 border-2 border-primary shadow-sm rounded-lg cursor-pointer bg-pink-200/70";

  return (
    <nav className="right-auto w-[16rem] hidden md:block fixed bg-slate-100 inset-0 pb-10 px-5 overflow-y-auto shadow-md">
