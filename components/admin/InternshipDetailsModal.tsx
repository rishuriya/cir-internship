             ...
             Details:
              ...
              Edit
                  ...
                  !editDetail ?
                              ...
                              :
                              <input required onChange={(e)=>{setCompanyName(e.target.value)}} className="appearance-none block w-full bg-gray-100 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" name="company_name" id="grid-company-name" defaultValue={companyName} type="text" placeholder="Company Name" />
                              }{" "}
                              <span>
                                ({" "}
                                <a
                  ...
                  !editDetail ?
                            ...
                            :
                            <input required onChange={(e)=>{setCompanyLocation(e.target.value)}} className="appearance-none block w-full bg-gray-100 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" name="company_location" id="grid-company-location" defaultValue={companyLocation} type="text" placeholder="Company Location" />
                            }
                            </span>
                          </div>
                          <div className="flex mb-2">
                  ...
                  !editDetail ?
                            ...
                            :
                            <input required onChange={(e)=>{setCompanyMobile(e.target.value)}} className="appearance-none block w-full bg-gray-100 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" name="company_mobile" id="grid-company-mobile" defaultValue={companyMobile} type="text" placeholder="Company Mobile" />
                            }
                            </span>
                  ...
                  <span className="w-2/3">
                            ...
                            <input required onChange={(e)=>{setStartDate(e.target.value)}} className="appearance-none block w-full bg-gray-100 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" name="internship_start_date" id="grid-start-date" type="date" placeholder="Start Date" defaultValue={startDate.toString().substring(0,10)} />
                            
                            
                              <p className="text-base text-black ml-2">
                              End Dates :{" "}
                            </p>
                            <input required onChange={(e)=>{setEndDate(e.target.value)}} className="appearance-none block w-full bg-gray-100 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" name="internship_end_date" id="grid-end-date" type="date" placeholder="End Date" defaultValue={endDate.toString().substring(0,10)} />
