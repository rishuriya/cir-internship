    ...
    fetch(`/api/student/showBranch`, {
      ...
      if (resData.success) {
        if (resData.branch.length == 1) {
          var a = Array.from(
            { length: resData.branch[0].semester },
            (_, i) => i + 1
          );
          setSemList(a);
        }
    ...
    <div className="bg-secondary h-screen w-full relative p-2">
      <div className="w-11/12 mx-auto max-w-5xl my-6 pt-5 pb-10 bg-slate-700/80 flex flex-col z-10 shadow-xl rounded-lg p-5">
        <form onSubmit={handleSubmit} className="w-full">
          <div
            className="my-3 mx-2 text-white font-semibold uppercase"
          ...
          <div className="flex flex-wrap -mx-3 mb-6">
            <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
              ...
              <input
                pattern=".*@am\.students\.amrita\.edu"
                required
                className="appearance-none block w-full bg-gray-100 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                name="email"
                id="email"
            ...
            <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
              ...
              <input
                pattern="[0-9,+]{10,15}"
                title="Type numbers without spaces/Number invalid"
                required
                className="appearance-none block w-full bg-gray-100 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                name="phone"
                id="phone-number"
