...
<div className="w-1/2 mx-auto mt-24 py-10 bg-sky-200 flex flex-col bg-slate-300/40 z-10 shadow-xl rounded-lg items-center p-5">
<form className="w-full">
  ...
  <div className="flex flex-wrap -mx-3 mb-6">
    <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
      ...
      <input className="appearance-none block w-full bg-gray-100 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="name" type="text" placeholder="Amrita"/>
    </div>
    <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
